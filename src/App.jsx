  ...
  return (
    <Routes>
      ...
      <Route element={<PlatformLayout />}>
        ...
        <Route path="/platform/restaurants/:id" element={<PlatformRestaurantDetail />} />
        ...
        <Route path="/platform/subscriptions/create" element={<PlatformCreatePlan />} />
      ...
      <Route element={<RestaurantLayout />}>
        ...
        <Route path="/restaurant/menu/category/new" element={<RestaurantCategoryForm />} />
        <Route path="/restaurant/menu/category/:id/edit" element={<RestaurantCategoryForm />} />
        <Route path="/restaurant/menu/item/new" element={<RestaurantMenuItemForm />} />
        <Route path="/restaurant/menu/item/:id/edit" element={<RestaurantMenuItemForm />} />
        ...
        <Route path="/restaurant/tables/new" element={<RestaurantTableForm />} />
        <Route path="/restaurant/tables/:id/edit" element={<RestaurantTableForm />} />
        <Route path="/restaurant/employees" element={<RestaurantEmployees />} />
        <Route path="/restaurant/employees/new" element={<RestaurantEmployeeForm />} />
        <Route path="/restaurant/employees/:id/edit" element={<RestaurantEmployeeForm />} />
        <Route path="/restaurant/kyc" element={<RestaurantKYC />} />
        <Route path="/restaurant/subscription" element={<RestaurantSubscription />} />
      ...
      <Route path="/" element={
        ...
        user.role === 'super_admin' || user.role === 'admin' ? <Navigate to="/platform/dashboard" /> :
        user.role === 'restaurant' ? <Navigate to="/restaurant/dashboard" /> :
        user.role === 'kitchen' ? <Navigate to="/kitchen/dashboard" /> :
        user.role === 'cashier' ? <Navigate to="/cashier/dashboard" /> :
        <Navigate to="/login" />
      } />
      
      {/* Catch all - 404 */}
      <Route path="*" element={<div className="min-h-screen flex items-center justify-center"><div className="text-center"><h1 className="text-4xl font-bold text-gray-900">404</h1><p className="text-gray-500 mt-2">Page not found</p></div></div>} />
    </Routes>
  )
}
