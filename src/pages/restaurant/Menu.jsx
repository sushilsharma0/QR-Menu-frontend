...
const Menu = () => {
  ...
  const handleToggleAvailability = async (itemId, currentStatus) => {
    try {
      ...
      toast.success(
        `Item marked as ${currentStatus ? "unavailable" : "available"}`,
      );
      fetchMenuData();
    } catch (error) {
            ...
            >
              <div className="flex justify-between items-start">
                <div className="flex-1">
                  ...
                  {/* ✅ Fix 2 — stringify both sides for accurate count */}
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              ...
              {filteredItems.length === 0 && (
                <tr>
                  ...
                  >
                    No menu items found in this category. Click "Add Menu Item"
                    to create one.
                  </td>
                </tr>
              )}
        ...
        <div className="p-6">
          <p className="text-gray-700">
            ...
            {deleteModal.type === "category" &&
              " Items in this category will not be deleted."}
          </p>
