  ...
  return (
    <motionlessOverlay>
      <div className="w-full max-w-lg rounded-2xl border border-gray-200 bg-white p-6 shadow-2xl dark:border-gray-800 dark:bg-gray-900">
        ...
        <motionlessActions dismiss={dismiss} navigate={navigate} restaurantBase={restaurantBase} />
      </div>
    </motionlessOverlay>
  )
}

function motionlessActions({ dismiss, navigate, restaurantBase }) {
  return (
...
function motionlessOverlay({ children }) {
  return (
