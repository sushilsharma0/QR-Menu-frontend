...
const SectionHeader = ({ eyebrow, title, description, align = 'center', tone = 'light' }) => (
  ...
  >
    ...
    <h2
      className={
        tone === 'dark'
          ? 'mt-3 text-2xl font-black leading-tight tracking-tight text-white sm:mt-4 sm:text-3xl md:text-4xl lg:text-5xl'
          : 'mt-3 text-2xl font-black leading-tight tracking-tight text-slate-950 sm:mt-4 sm:text-3xl md:text-4xl lg:text-5xl'
      }
    >
      {title}
    </h2>
