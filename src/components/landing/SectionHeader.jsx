...
const SectionHeader = ({ eyebrow, title, description, align = 'center', tone = 'light' }) => (
  ...
  >
    <p className={tone === 'dark' ? 'text-sm font-black uppercase tracking-[0.25em] text-emerald-300' : 'text-sm font-black uppercase tracking-[0.25em] text-emerald-700'}>{eyebrow}</p>
